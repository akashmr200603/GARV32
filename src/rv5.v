...
module rv5 #(
  ...
  wire pinmux_ack;
  assign device_read_response[D12_PINMUX]  = pinmux_ack;
  assign device_write_response[D12_PINMUX] = pinmux_ack;
  ...
  rv5_pinmux rv5_pinmux_instance (
    ...
    .bus_we                         (device_write_request[D12_PINMUX]   ),
